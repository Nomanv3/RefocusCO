...
function Navbar() {
  return (
    <div className="max-w-screen-lg mx-auto py-4 px-2 bg-zinc-900 flex items-center justify-between border-b-[1px] border-zinc-700">
      ...
      <img
        ...
        alt=""
        />
      <div className="Links flex gap-12 ml-20 items-center ">
        {["Home", "Work", "Culture", "", "News"].map((elem, index) =>
          ...
          (
            <a 
            key={index}
            className="text-sm font-regular text-white flex items-center gap-1">
              {index === 1 && (
                <span
